...
export default class General extends Component {
  ...
  flattenPrograms(general) {
    let programs = [];
    if (general.special_ed_indicator && general.special_ed_indicator !== '0') {
  ...
  render() {
    ...
    const displayProgramsTable = (this.props.general.special_ed_indicator && this.props.general.special_ed_indicator !== '0') || this.props.general.ell_indicator;
